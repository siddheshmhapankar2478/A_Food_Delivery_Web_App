...
const Body = () => {
  ...
  const [allRestroData, setAllRestroData] = useState(restaurantListMain);
  const [filtererdRestroData, setFiltererdRestroData] =
    useState(restaurantListMain);
